        ...
        <div className="flex-1 w-full max-w-xs">
          <div className="bg-gray-50 rounded-xl shadow p-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="bg-white rounded-lg p-4 text-center shadow-sm hover:shadow-lg hover:scale-105 hover:bg-blue-50 transition-all duration-300 cursor-pointer">
